...
$string['group_deactivated'] = 'Group is deactivated';
$string['groupid_missing'] = 'Groupid is missing';
$string['groups_missing'] = 'Groups have not been set up';
$string['lessthentwogroups'] = 'Less then 2 groups have been set up';
$string['groupsdefined'] = 'Groups are well defined';
