...
$string['checker_link_error_curl'] = 'CURL Error {$a->curl_errno} {$a->curl_error} on {$a->scheme}:://{$a->host}'; // You can get any curl info or pare_url field in $a.
$string['checker_link_error_code'] = 'HTTP Error {$a->http_code} on {$a->scheme}://{$a->host}'; // You can get any curl info or pare_url field in $a.
$string['checker_link_ok'] = '{$a->scheme}://{$a->host} is valid (Code {$a->http_code})'; // You can get any curl info or pare_url field in $a.
